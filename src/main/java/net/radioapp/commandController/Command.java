...
public abstract class Command {
    protected String name, helpMessage, resumeMessage, resultMessage;
    protected String[] aliases = new String[0];
    public Action call(String[] args){return new Action("error","Acción no implementada", ActionType.LOG);}
